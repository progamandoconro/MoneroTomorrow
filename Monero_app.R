...
ui <- dashboardPage(
    ...
    dashboardSidebar(
        ...
        sliderInput("range", "Tiempo (Últmos 200 días de la data de entrenamiento):",
                     ...
                     textOutput('text1'),
        h3( tags$b( tags$a(href="https://rodlupanow.shinyapps.io/mapa/", "Click para ver Mapa de la cuenca del río Apure")))
    ...
    dashboardBody(
        h3("Resultados de SVM entrenado con 1000 días antes de hoy",Sys.Date()),
        plotOutput("gPlot"),
